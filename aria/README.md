...
### 시나리오 E: 마케팅 활동 사전 컴플라이언스 체크 (Mode 3)

1. `/aria:chat`에 "컴플라이언스 체크" + 활동 설명 입력
2. 활동유형 자동 분류 → 경계선이면 후보 중 선택
3. 맥락 확인 (기획검토/신고준비/사후확인)
4. Checklist 질문에 Yes/No/확인필요로 순차 응답
5. GREEN/YELLOW/RED 판정 + 후속 절차(지출보고서 등) 안내
6. 필요 서류 검토 제안 → 폴더에서 검색 또는 업로드
