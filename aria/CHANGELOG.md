...
### Changed
- Removed tracked knowledge-audit reports and legacy knowledge-build scripts from the shipped repo surface
- Kept archived copies only in local `_archive/legacy-v1-transition/`
