...
source:
  ...
  path: "480_Points_to_Consider_for_Cervical_Cytology_Devices.pdf"
  pages: 18
...
( D U D ) for guidance and review of protocols prior to submission of a fonnal application,
...
Reproducibiiity (inter-observer, -laboratory, -instrument, intra-observer,instrument)
...
various extremes of temperature, humidity, and light. This includes precollection buffer solutions and post-collection preservation of cellular
morphology.
...
can be grouped into three treatment categories: negative, ASCUS, and LGSIL and above. These data are ordinally scaled
...
of disease (LGSILand higher) for the reference and new device
respectively.
...
intervals for true clinical sensitivity based on the diseasepositive confirmed group and clinical specificity based on the
...
conventional Pap smear and as a comparison method for thinlayer or monolayer slide preparations. Record the masked
...
Pap smear and for the new device, e.g., an automated or semiautomated image analysis or computer-assisted cell locator
device.
...
Pap smear and the other group will be sampled for the nonconventional method, e.g., thin layer or monolayer slides.
...
cells? What is the operatorlinstrument interaction? What type of longterm record is provided? Documentation for software that was designed
...
Medical Devices Undergoing 51O(k) Review.
...
S t ~ t ethe kind and amount of training requirements for any step and interpretation that
...
suspensions for thin layer slides, computer-assisted cell locator devices, serniautomated and automated computer-assisted image analyzers, and any other device
...
cervicaVvagina1 cytological diagnosis. J A M . 1989;262:931-934.
Broder S. Rapid communication--the Bethesda system for reporting cervicdvagind
cytologic diagnosis--report of the 1991 Bethesda Workshop. JAA4A. 1992;267:1892.
K u m m RJ, Henson DE, Herbst AL, et a]. Interim guidelines for Management of
Abnonnal Cervical Cytology. JAMA. l994;271 :1866- 1869.
