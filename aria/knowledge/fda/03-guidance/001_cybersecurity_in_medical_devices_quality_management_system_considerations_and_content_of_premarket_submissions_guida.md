...
source:
  ...
  title: 'Cybersecurity in Medical Devices: Quality Management System Considerations
    and Content of Premarket Submissions:  Guidance for Industry and Food and Drug
...
device meets the cybersecurity requirements under section 524B(b).
14
 
Under section 524B(a) of 
...
Section 524B(c) of the FD&C Act defines “cyber device” as a device that “(1) 
...
| incorporates by reference ISO 13485. Depending on the device, Q |  |  |  |  |  |
...
Additional information on premarket documentation recommendations for design and 
development are discussed in the Security Architecture Views section below.
2.
Security Architecture Views 
In addition to the design and development requirements,
46
 
Subclause 8.5 of ISO 13485 requires 
...
| --- | --- |
| section. These architecture views can contribute to the demonstration of safety and effectivenes |  |
| in premarket submissions by illustrating how the controls to address cybersecurity risks have been applied to the medical device system. |  |
...
| The security architecture may be expressed at different levels of abstraction and with differen |  |
| --- | --- |
...
risk of the device.
45
 For more information, see FDA’s guidance “
...
| requirements | ,46 Subclause 8.5 of ISO 13485 requires |
| --- | --- |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | Submission Documentation |  |  | Section(s) |  |  |  |  |
| - Threat Model (may include Architecture Views) | - Threat Model (may |  |  | Sections |  | Could be helpful to submit, but not specifically recommended (see Architecture View recommendations) |  |  |
|  | include Architecture |  |  | V.A.1, V.A.3, |  |  |  |  |
|  | Views) |  |  | V.A.4, V.A.5, |  |  |  |  |
|  |  |  |  | V.B.2, |  |  |  |  |
|  |  |  |  | Appendix 1, |  |  |  |  |
|  |  |  |  | Appendix 2 |  |  |  |  |
| - Cybersecurity Risk Assessment |  |  |  | Sections |  | Could be helpful to submit, but not specifically recommended |  |  |
|  |  |  |  | V.A.2, V.A.3, |  |  |  |  |
|  |  |  |  | V.A.4, V.A.5, |  |  |  |  |
|  |  |  |  | V.A.6 |  |  |  |  |
| - SBOM |  |  |  | Sections |  | Recommended |  |  |
|  |  |  |  | V.A.4, VI.A |  |  |  |  |
|  | - Vulnerability |  | Section V.A.4 | Section V.A.4 |  | Could be helpful to submit, but not specifically recommended |  |  |
|  | Assessment and |  |  |  |  |  |  |  |
|  | Software Support |  |  |  |  |  |  |  |
|  | - Unresolved |  | Section V.A.5 |  |  | Could be helpful to submit, but not specifically recommended |  |  |
|  | Anomalies |  |  |  |  |  |  |  |
|  | Assessment |  |  |  |  |  |  |  |
| - Traceability | - Traceability |  |  | Sections V.A, |  | Could be helpful to submit, but not specifically recommended |  |  |
|  |  |  |  | V.A.1, V.A.2, |  |  |  |  |
|  |  |  |  | V.A.3, V.A.4. |  |  |  |  |
|  |  |  |  | V.A.5, V.A.6, |  |  |  |  |
|  |  |  |  | V.B.1, V.B.2, |  |  |  |  |
|  |  |  |  | V.C, VI.A |  |  |  |  |
| Measures and Metrics |  |  | Section V.A.6 | Section V.A.6 |  |  | Could be helpful to submit, but not |  |
...
|  |  |  |  |  |  |  | · Security Use Case views for |  |
|  |  |  |  |  |  |  | functionality with safety risks |  |
| - Architecture Views (may be included in Threat Model) |  |  | Sections V.A.1, V.B.2, Appendix 1, Appendix 2 |  |  |  | Recommended |  |
|  |  |  |  |  |  |  | · Global, Multi-patient and |  |
|  |  |  |  |  |  |  | Updateability/Patchability views |  |
|  |  |  |  |  |  |  | · Security Use Case views for |  |
|  |  |  |  |  |  |  | functionality with safety risks |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | Submission Documentation |  |  | Section(s) |  |  |  |  |
| Labeling | Labeling |  | Section VI.A | Section VI.A |  |  | Recommended |  |
...
|  | Cybersecurity Management |  | Section VI.B |  |  |  | Could be helpful to submit, but not |  |
...
a process (or processes) that evaluates and controls threat-based 
risks. For security risk management, this includes 
an evaluation of the impact of exploitation on the 
device’s safety and effectiveness, the exploitability, and the severity of patient harm if exploited. 
Software Bill of Materials (SBOM) 
– a formal inventory of software components and 
...
of an SBOM.
System
 – the combination of interacting elements or assets organized to achieve one or 
more function.
118
Threat
 – any circumstance or event with the potential to adversely impact the device, 
...
Threat modeling
 – a methodology for optimizing system, product, network, application, and 
...
.
116
 Definition is cited from NIST SP 800-108 
Recommendation for Key Derivation Using Pseudorandom Functions
.
https://doi.org/10.6028/NIST.SP.800-108
117
 Definition is adapted from NTIA’s 
Framing Software Component Transparency: Establishing a Common 
Software Bill of Materials (SBOM)
.
118
 Definition is adapted from ISO/IEC/IEEE 12207 
...
120
 Definition is adapted from CNSSI 4009 
CNSS Glossary
.
58
...
**The Notice of Availability is accessible via the 
