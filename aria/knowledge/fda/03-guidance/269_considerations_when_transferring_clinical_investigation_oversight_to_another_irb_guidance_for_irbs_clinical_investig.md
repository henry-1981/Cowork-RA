...
source:
  ...
  docket: "FDA-2011-D-0835"
  path: "269_Considerations_When_Transferring_Clinical_Investigation_Oversight_to_Another_IRB_Guidance_for_IRBs_Clinical_Investigators_and_Sponsors.pdf"
  pages: 17
...
Temporary Transfer of IRB Review Responsibility.......................................................................... 12
...
clinical investigators, and sponsors when oversight of a previously approved, ongoing clinical
...
Human Research Protections (OHRP) have been actively working to harmonize the agencies'
...
Research Project to a New IRB or Research Institution.” 2
...
2
OHRP’s guidance is available at: http://www.hhs.gov/ohrp/newsroom/rfc/transferdraftdoc.html.
1
...
of the human subjects. 3 To prevent lapses in human subject protection, it is generally preferred
...
clinical investigator in clinical investigations of new drugs and biological products, 4 and on the
...
Contains Nonbinding Recommendations
sponsor in clinical investigations of medical devices. 5 In practice, however, the party that
...
modifications to the informed consent document required by the receiving IRB). 6
...
consider when transferring oversight. 8
...
between the original and receiving IRBs, if appropriate. 9,10 The agreement should address how
...
Multicenter Clinical Trials,” available at http://www.fda.gov/RegulatoryInformation/Guidances/ucm127004.htm.
9
...
responsibilities for the study once transferred. 11 Pertinent records include documents such as the
...
available to the receiving IRB. 12 This can be accomplished by providing the receiving
IRB with paper or electronic copies of the pertinent records. 13 It is important to note that
the sponsor’s concurrence is necessary because the records may contain confidential
...
procedural and review obligations for the studies once transfer is complete. For example, under 21 CFR 56.108(a)
...
and/or investigator should work expeditiously to arrange for oversight by another IRB.
13
For more information on creating, maintaining, and archiving electronic records for regulatory purposes, see
FDA’s guidance, “Computerized Systems Used in Clinical Investigations,” available at
...
the clinical investigations affected by the transfer. 14 Such records should include: any
...
reasonable manner. 16 Because FDA may require access to the records at any reasonable
...
receiving IRB may choose to receive all of the records. 17 When the original and
...
arrangements. 18 In this situation, the original IRB should make arrangements to transfer
...
be considered suspended or terminated with no further subject enrollment. 19, 20, 21 The original
IRB must follow its written procedures for ensuring prompt reporting to its institutional officials
and FDA of the suspension or termination, as required under 21 CFR 56.108(b)(3). 22 In
...
investigation within 5 working days after receipt of the withdrawal of approval. 23 Sponsors of
drug/biologic studies must report to FDA the discontinuance of a clinical investigation. 24
...
review date established by the original IRB. 25 In practice, however, IRBs often choose to
perform some type of review before accepting responsibility for a study, as part of their own due
diligence efforts.
A number of options are available to the receiving IRB, depending on the circumstances. The
receiving IRB may decide to:
• Undertake an initial review, either by the convened IRB or under an expedited review
procedure, 26 if appropriate. Review by the receiving IRB is strongly recommended
where the quality of the review by the original IRB may be questionable, for example,
...
ensure that the rights and welfare of currently enrolled subjects are protected, subjects are not put at risk, and
...
22
See “IRB Continuing Review after Clinical Investigation Approval,” available at:
http://www.fda.gov/downloads/RegulatoryInformation/Guidances/UCM294558.pdf.
23
21 CFR 812.150(b)(2).
24
...
duplication of effort. See 21 CFR 56.114 (Cooperative research).
26
...
the transfer occurs because of noncompliance by the original IRB. 27
...
most appropriate for transfers due to logistical, administrative, or economic reasons. In
...
are sufficiently familiar with the study. 28
FDA regulations at 21 CFR part 56 make no provision for a grace period extending the conduct
...
approval. 29, 30 Overall, FDA expects that lapses of IRB approval will be a rare occurrence.
...
serious harm to subjects. 31 The receiving IRB must promptly report any suspension or
termination of IRB approval, including the reasons for the action, to the clinical investigator,
27
...
Contains Nonbinding Recommendations
appropriate institutional officials, and FDA. 32, 33 FDA recommends that sponsors also be
informed of any suspension or termination and the reasons for such action. 34 Informing sponsors
...
contact in the event of a research-related injury to the subject.” 35 Therefore, when a change in
...
information. 36 For new subjects, the informed consent, assent, and/or parental permission form
must be revised to reflect the new contact information. 37 The clinical investigator should
...
approval (e.g., changes in template language, changes in risks, etc.). 38 Depending upon the types
...
investigation is complete, the sponsor must update the associated IND 40 or IDE 41 with the name
...
have written agreements with the original IRB (to transfer review responsibility to that original
...
such minor changes; however, IRBs may choose to do so.
37
21 CFR 50.25(a)(7).
38
...
(8) Updating IRB registration information.
The IRB registration rule at 21 CFR 56.106(e) requires that any IRB that decides to review FDAregulated research involving new types of FDA-regulated products, or decides to discontinue
...
http://ohrp.cit.nih.gov/efile. 43
IV.
...
same institution for logistical, administrative, and/or budgeting reasons (e.g.,
...
administrative reasons), the transfer process is generally expected to be simpler and more
...
provided in Section III for institution-to-institution transfers may be useful for withininstitution transfers.
When a temporary transfer of IRB oversight occurs (e.g., due to a natural disaster)
whether within the same institution or to a different institution, the guidance provided in
...
of Good Clinical Practice, Office of Special Medical Programs, Food and Drug Administration, 10903 New
...
the changes. 44 In many cases, these changes represent a “minor change” to the research,
which the IRB may review under an expedited review procedure. 45
...
change in research without first conducting an initial or continuing review). 46
...
move is considered a change in previously approved research. 47 Additionally, the
...
accomplished in an IDE annual report. 48
V.
...
at (301) 796-8340 or by e-mail at gcp.questions@fda.hhs.gov.
