...
source:
  ...
  title: 'The Content of Investigational Device Exemption (IDE) and Premarket Approval
    (PMA) Applications for Artificial Pancreas Device Systems:  Guidance for Industry
...
in 
Section VI.K
 of the guidance. Such an analysis should evaluate combinations of 
...
Section VII.A
 of the guidance) where patient safety has 
been significantly mitigated due to physician monitoring, a limited sensitivity analysis 
is acceptable.  
6.
 
Summary of the Verification Activities for the APDS Control Algorithm
...
Pivotal Study:
 The need for accurate glucose information also exists for 
...
and method of determination may be affected by the 
subject’s current blood 
...
Sterilization Risk 
– The Sponsor should identify and describe if all of the devices 
