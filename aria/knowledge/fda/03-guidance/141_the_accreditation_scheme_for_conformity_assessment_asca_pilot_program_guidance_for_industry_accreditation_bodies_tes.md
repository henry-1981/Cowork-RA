...
source:
  ...
  path: "141_The_Accreditation_Scheme_for_Conformity_Assessment_ASCA_Pilot_Program_Guidance_for_Industry_Accreditation_Bodies_Testing_Laboratories_and_Food_and_Drug_Administ.pdf"
  pages: 49
...
Contains Nonbinding Recommendations
This guidance refers to voluntary consensus standards.5 For the current edition of the FDArecognized consensus standard(s) referenced in this document, see the FDA Recognized
