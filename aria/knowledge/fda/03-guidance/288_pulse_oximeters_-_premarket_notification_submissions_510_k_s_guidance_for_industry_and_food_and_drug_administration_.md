...
source:
  ...
  path: "288_Pulse_Oximeters_-_Premarket_Notification_Submissions_510_k_s_Guidance_for_Industry_and_Food_and_Drug_Administration_Staff.pdf"
  pages: 19
...
dsmica@fda.hhs.gov to receive an electronic copy of the guidance or send a fax request to 301827-8149 to receive a hard copy. Please use the document number (1605) to identify the
...
Web addresses for all guidance documents referenced within can be found in the “List of References” at the end of
this document.
...
We recommend that you conduct the testing described in Clause 201.12.1 of ISO 80601-261:2011 or equivalent methods.
...
We recommend you follow Clause 201.12.1.101.2 and Annex EE.2 of ISO 80601-261:2011 Procedure for invasive laboratory testing on healthy volunteers, or equivalent
...
(μ0), between-subject variance (σμ2), within-subject variance (σ2), and upper 95% and
...
See Bland and Altman. Agreement between methods of measurement with multiple observations per individual.
...
an identification of whether the system and accessories are provided sterile or nonsterile;
...
Although final labeling is not required for 510(k) clearance, final labeling must comply with the requirements of 21
