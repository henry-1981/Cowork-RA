...
source:
  ...
  docket: "FDA-2006-D-0362"
  path: "309_Patient-Reported_Outcome_Measures_Use_in_Medical_Product_Development_to_Support_Labeling_Claims_Guidance_for_Industry.pdf"
  pages: 43
...
EVALUATION OF A PRO INSTRUMENT ................................................................. 3
...
Choice of PRO Instrument............................................................................................................ 5

C.

Conceptual Framework of a PRO Instrument............................................................................ 7

1. Concepts Measured.......................................................................................................................... 7
2. Intended Population....................................................................................................................... 10
D. Content Validity ........................................................................................................................... 12
1. Item Generation ............................................................................................................................. 12
2. Data Collection Method and Instrument Administration Mode .................................................... 13
3. Recall Period ................................................................................................................................. 14
4. Response Options........................................................................................................................... 14
5. Instrument Format, Instructions, and Training ............................................................................. 16
6. Patient Understanding ................................................................................................................... 16
7. Scoring of Items and Domains....................................................................................................... 16
8. Respondent and Administrator Burden.......................................................................................... 17
E. Reliability, Other Validity, and Ability to Detect Change ....................................................... 18
1. Reliability....................................................................................................................................... 18
2. Other Validity ................................................................................................................................ 19
3. Ability to Detect Change................................................................................................................ 20
F. Instrument Modification ............................................................................................................. 20
G.

PRO Instruments Intended for Specific Populations ............................................................... 21
1. Children and Adolescents .............................................................................................................. 21
2. Patients Cognitively Impaired or Unable to Communicate........................................................... 21
3. Culture or Language Subgroups.................................................................................................... 22
...
General Protocol Considerations................................................................................................ 22

1. Blinding and Randomization.......................................................................................................... 22
2. Clinical Trial Quality Control ....................................................................................................... 23
3. Handling Missing Data.................................................................................................................. 23
B. Frequency of Assessments........................................................................................................... 24
C.

Clinical Trial Duration ................................................................................................................ 24

D.

Design Considerations for Multiple Endpoints ......................................................................... 24

E.

Planning for Clinical Trial Interpretation Using a Responder Definition.............................. 24

F.

Specific Concerns When Using Electronic PRO Instruments ................................................. 26
...
General Statistical Considerations ............................................................................................. 27

B.

Statistical Considerations for Using Multiple Endpoints ......................................................... 28
i

C.

Statistical Considerations for Composite Endpoints ................................................................ 29

D.

Statistical Considerations for Patient-Level Missing Data....................................................... 29

1. Missing Items within Domains....................................................................................................... 30
2. Missing Entire Domains or Entire Measurements......................................................................... 30
E. Interpretation of Clinical Trial Results ..................................................................................... 30

GLOSSARY................................................................................................................................. 31
APPENDIX: INFORMATION ON A PRO INSTRUMENT REVIEWED BY THE FDA 35
...
Labeling, as used in this guidance, refers to the information about an FDA-approved medical product intended for
...
See the following FDA Web sites:
...
Contains Nonbinding Recommendations
during a clinical trial, and provide optimal information about the patient perspective for use in
...
EVALUATION OF A PRO INSTRUMENT
...
See the draft guidance for industry and review staff Target Product Profile — A Strategic Development
...
Although the TPP process is used for drug and biologic approvals, the concept of beginning with the desired
...
Contains Nonbinding Recommendations
Requests for FDA input should be addressed to the review division responsible for the medical
...
Contains Nonbinding Recommendations
domains of the general concept contained in the claim. However, the complex nature of
...
Type
Test-retest or intrainterviewer reliability (for
...
Contains Nonbinding Recommendations
pilot testing; importance ratings; and quantitative techniques for item evaluation. Table 1 lists
...
Contains Nonbinding Recommendations
collection methods can include paper-based, computer-assisted, and telephone-based
...
Contains Nonbinding Recommendations
scales). We will review the distribution of item responses to ensure that the response choices
...
We will review documentation of tests to determine if reproducibility (e.g., test-retest reliability)
...
in the same protocol. We acknowledge that for remitting and relapsing or episodic diseases, testretest reliability may be difficult or impossible to establish.
...
Contains Nonbinding Recommendations
comparing a new sleep scale to a clinical measure of polysomnography). However, for most
...
PRO Instruments Intended for Specific Populations
...
Contains Nonbinding Recommendations
trial, we encourage sponsors to include a single item during or at the end of the trial to ask
...
Contains Nonbinding Recommendations
establish a process by which PRO measurement is obtained before or shortly after patient
...
exploratory. A PRO measurement can be the clinical trial’s primary endpoint measure, a coprimary endpoint measure in conjunction with another PRO measure, other clinical endpoints or
...
Contains Nonbinding Recommendations
design characteristics. Therefore, we will evaluate an instrument’s responder definition in the
...
For the principal record keeping requirements for clinical investigators and sponsors developing drugs and
...
See the guidance for industry Part 11, Electronic Records; Electronic Signatures — Scope and Application
(http://www.fda.gov/Drugs/GuidanceComplianceRegulatoryInformation/Guidances/default.htm).
26
...
See the ICH guidance for industry E9 Statistical Principles for Clinical Trials
(http://www.fda.gov/Drugs/GuidanceComplianceRegulatoryInformation/Guidances/default.htm).
27
...
Statistical Considerations for Using Multiple Endpoints
...
than the conventional nonhierarchical type methods, such as Bonferroni, the step-down or stepup tests, and prospective alpha allocations schemes, which ignore the hierarchy of comparisons
...
Contains Nonbinding Recommendations
the specific claim. The use of domain subsets as clinical trial endpoints presupposes that the
...
See the guidance for industry Clinical Studies Section of Labeling for Human
Prescription Drug and Biological Products — Content and Format
(http://www.fda.gov/Drugs/GuidanceComplianceRegulatoryInformation/Guidances/default.htm).
29

Contains Nonbinding Recommendations
Even with the best planning, data may be missing at the end of the clinical trial. The SAP should
...
Missing Entire Domains or Entire Measurements
...
Endpoint — The measurement that will be statistically compared among treatment groups to
...
instructions for administration or responding, a standard format for data collection, and welldocumented methods for scoring, analysis, and interpretation of results in the target patient
population.
...
Quality of life — A general concept that implies an evaluation of the effect of all aspects of life
...
Contains Nonbinding Recommendations
directly capture the treatment effect on how a patient survives, feels, or functions are surrogate
...
Contains Nonbinding Recommendations
APPENDIX: INFORMATION ON A PRO INSTRUMENT
REVIEWED BY THE FDA
...
See the ICH guidance for industry M2 eCTD: Electronic Common Technical Document Specification
(http://www.fda.gov/Drugs/GuidanceComplianceRegulatoryInformation/Guidances/default.htm).
12
...
non-PRO. These endpoints can include physiologic/lab/physical, caregiver, or clinicianreported measures in addition to PROs.
...
E. Summary of qualitative studies demonstrating how item pool was generated, reduced,
...
Contains Nonbinding Recommendations
If electronic data collection is used to assess PRO endpoints, evidence that procedures for
