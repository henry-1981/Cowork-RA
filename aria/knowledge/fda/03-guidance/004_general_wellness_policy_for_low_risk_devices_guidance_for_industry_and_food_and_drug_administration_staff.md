...
source:
  ...
  path: "004_General_Wellness_Policy_for_Low_Risk_Devices_Guidance_for_Industry_and_Food_and_Drug_Administration_Staff.pdf"
  pages: 15
...
FD&C Act.
This guidance does not change or rescind any requirements of the Federal Food, Drug, and Cosmetic Act
...
2
For determinations on combination products, contact the Office of Combination Products at
...
Applications, available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/policydevice-software-functions-and-mobile-medical-applications.
3
...
Products intended to restore a structure or function impaired due to a disease might be regulated by FDA as
...
By organizations we mean associations and colleges such as American Medical Association (AMA),
...
Whether a device is classified as class I under section 513(a)(1) of the FD&C Act does not necessarily mean
that it is “low risk” for purposes of this guidance.
9
For purposes of this guidance, “invasive” means penetrates or pierces the skin or mucous membranes of the
body.
8
...
See the FDA Guidance: Class II Special Controls Guidance Document: External Penile Rigidity Devices,
issued on December 28, 2004, available at https://www.fda.gov/regulatory-information/search-fda-guidancedocuments/class-ii-special-controls-guidance-document-external-penile-rigidity-devices-guidance-industry-and
11
See Final Order reclassifying UV lamps intended to tan the skin from class I exempt from premarket
...
Sunlamp Products, available at https://www.federalregister.gov/articles/2014/06/02/2014-12546/general-andplastic-surgery-devices-reclassification-of-ultraviolet-lamps-for-tanning-henceforth-to
10
...
Go to A3. Both questions A2(a) and A2(b) must be answered “Yes” in
order to proceed to question A3.
Product is NOT a low risk general wellness product, and is outside the
...
The product is likely a general wellness product within the scope of
