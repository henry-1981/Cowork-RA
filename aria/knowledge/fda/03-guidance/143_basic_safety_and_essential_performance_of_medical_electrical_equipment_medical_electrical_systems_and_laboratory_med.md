...
source:
  ...
  pages: 28
  path: 143_Basic_Safety_and_Essential_Performance_of_Medical_Electrical_Equipment_Medical_Electrical_Systems_and_Laboratory_Medical_Equipment_-_Standards_Specific_Informat.pdf
  title: 'Basic Safety and Essential Performance of Medical Electrical Equipment,
    Medical Electrical Systems, and Laboratory Medical Equipment - Standards Specific
    Information for the Accreditation Scheme for Conformity Assessment (ASCA) Pilot
    Program:  Guidance for Industry, Accreditation Bodies, Testing Laboratories, and
...
Submissions for Medical Devices
 that the device manufacturer submits as part of their 
...
: 
Title of Standard: 
(e.g., ANSI/AAMI ES60601-1 Medical electrical equipment - 
·
...
(e.g., Testing Laboratory ABC)___________________
...
Testing Location(s): 
(e.g., 1234 Example Road, Silver Spring, MD 20993)______
 
·
 
Testing Date(s): 
(e.g., Sep 1, 2020 – Sep 15, 2020)_________________________
...
¨
  Standard was not in testing laboratory’s scope of 
ASCA Accreditation 
¨
  Standard was in testing laboratory’s scope of 
ASCA Accreditation
; 
...
Supplemental Documentation 
(Refer to Section V.C. of this guidance for specific 
recommendations)
: 
¨
...
documentation: 
(e.g., Appendix A of this premarket submission)__________
...
|  | premarket submission: (e.g., Section V, pages 45-50) |
|  | _______________________ · Information on how any concerns communicated by the test laboratory were |
...
to Test Methods and/or Acceptance Criteria 
¨
...
Additional Testing Performed to Demonstrate Conformity with the Standard
16
¨
