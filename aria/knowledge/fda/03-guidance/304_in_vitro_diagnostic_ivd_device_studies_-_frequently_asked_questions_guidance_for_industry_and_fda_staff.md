...
(IRB) and compliance with informed consent requirements. A nonsignificant risk study is considered to have an approved IDE when the
...
effectiveness. For example, if you are studying an IVD device that uses a wellcharacterized technology and has an intended use that falls within a type of device
...
progresses?
We generally believe it would be inappropriate to draw conclusions from afterthe-fact hypotheses. We recommend that changes in study protocols be carefully
