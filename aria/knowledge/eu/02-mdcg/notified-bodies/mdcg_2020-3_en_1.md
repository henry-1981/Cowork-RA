...
source:
  ...
  pages: 21
  path: 02.MDCG/Notified bodies/mdcg_2020-3_en_1.pdf
  title: mdcg_2020-3_en_1
---
...
https://health.ec.europa.eu/document/download/592008f6-3456-4afb-a13a-
733a87da1b00_en?filename=mdr_proposal_extension-q-n-a_0.pdf 
...
8 See Article 120(3e) MDR and MDCG 2022-4 Guidance on appropriate surveillance regarding the transitional 
...
10 See Annex 2, Sect. 4.4. AIMDD and Annex II, Sect. 4.4. MDD: “The applicant shall inform the notified body ... of any 
...
14 Those change notification procedures may need to be adjusted in accordance with the principles outlined in this 
...
16 In case of class I devices (not certified by a NB), manufacturers may also drawn up a statement listing non-
significant changes performed to the device. This statement could accompany the Declaration of conformity previously 
issued. 
...
18 Changes to a medicinal substance – including a change in its manufacturing process – which has undergone 
...
As a rule, the following changes in design and/or intended purpose should be regarded as “non-
significant”: 
 
...
19 ‘Corrective action‘ refers to corrective action as defined in Article 2(67) MDR, i.e. any “action taken to eliminate the 
...
o new catheter variant, with length and diameter within current range and worst 
case in sterilisation performance; 
o new stent lengths which are intermediate between the previously certified stent 
lengths. 
 
...
 
change of label or packaging material of a non-sterile device e.g. a change in packag-
ing from one variant of polyethylene to another due to supplier rationalization or cost 
saving measures; 
 
change to primary package size within previously validated range and previously vali-
dated sterilisation parameters; 
...
o installation of a new firmware of software driver to operate the new semi-
conductor; 
o adjustments of the software operating the device to accommodate the new 
...
o new stent lengths which are outside of the range of the previously certified stent 
lengths; 
o addition of two or more electrodes, or a new anchoring mechanism on an 
...
software change to allow the healthcare professional to select and/or change the pre-
existing units of measure on a blood oxygen monitor); 
 
...
22 This section should be considered irrespective of whether the software is stand-alone or incorporated/utilised 
