...
source:
  family: "MDCG"
  title: "mdcg_2019_11_en"
  path: "02.MDCG/New Technologies/mdcg_2019_11_en.pdf"
  pages: 36
...
Scope clarification
3.
Addition of considerations related to the importance of
crafting a clear intended purpose and references to
modular MDSW
3.1.
Clarifications on the scope of document with regards to
Annex XVI software
3.2.
Addition of new examples, including MDSW intended to
treat.
4.2.1.
Addition of clarification to Rule 11 (Subrule a). Addition of
references and examples on devices intended to prevent
the risk of illness […].
7.
Update and further elaboration on ‘Modules’
...
Record Systems.
Annex IV
Inclusion of a new Class I example
...
Article 32.2(c), Annex I, Chapter III Section 23.4(f), Annex II Section 1.1(h) of Regulation (EU) 2017/745 –
...
in real life.
MDSW intended to add new functionalities to existing products (medical devices and nonmedical devices), such as:
-
...
videos, which are individually chosen based on the patient’s input to reduce depressionrelated symptoms.
...
found
at
https://ec.europa.eu/growth/sectors/medical-devices/newregulations/guidance_en. This is expected to provide useful orientation in relation to the
...
Compare IMDRF/SaMD WG/N12FINAL:2014 which states that there are two major factors that provide
...
on Classification of IVDs when available at https://ec.europa.eu/growth/sectors/medicaldevices/new-regulations/guidance_en.
...
rules
can be found at https://ec.europa.eu/growth/sectors/medical-devices/newregulations/guidance_en 30
...
Annex III - Usability of the IMDRF risk classification
